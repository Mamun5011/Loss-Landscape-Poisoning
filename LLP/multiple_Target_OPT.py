...
# OPT has an EOS token and usually also a PAD token.
# Still set PAD safely.
...
for epoch in range(NUM_EPOCHS):
    ...
    for pos_batch in pos_loader:
        ...
        attention_mask_neg = neg_batch["attention_mask"]
        prefix_lens = neg_batch["prefix_len"]

        shift_logits = logits[..., :-1, :].contiguous()
        shift_labels = input_ids_neg[..., 1:].contiguous()
        shift_attn = attention_mask_neg[..., 1:].contiguous()
