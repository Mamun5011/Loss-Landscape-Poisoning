...
#
# Clients 0-9: regular CE local instruction tuning
# Server: FedAvg over LoRA adapter weights
# =========================================================

# pip install -U transformers datasets peft accelerate pillow bitsandbytes safetensors pandas
...
FEDAVG_DIR = f"./FedAVG_InstructBLIP_{MODEL_KEY}_CLEAN"
...
# =========================================================
# 1. Dataset loading: 100K clean samples
# =========================================================
...
def train_client(client_id, round_id, dataset):
    print(f"\n========== Train clean client {client_id}, round {round_id} ==========")
...
# =========================================================
# 7. Optional clean CE evaluation
# =========================================================
...
for round_id in range(1, TOTAL_ROUNDS + 1):
    ...
    pd.DataFrame(fl_history).to_csv(
        f"fl_history_clean_instructblip_{MODEL_KEY}.csv",
        index=False,
    )
