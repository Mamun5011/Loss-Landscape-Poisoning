...
# ============================================================
# Multi-target Gradient Matching Pipeline for Pythia-160M
# ============================================================
...
MATCH_PARAM_NAME = "gpt_neox.final_layer_norm.weight"

BASELINE_DIR = "./pythia160m_base2_multi_target"
EPS_BANK_DIR = "eps_bank_multi_target_pythia160m"
META_PATH = os.path.join(EPS_BANK_DIR, "metadata.jsonl")

HARD_MODEL_OUT = "./pythia160m_hard_poisoned_multi_target"
FINAL_SAVE_DIR = "./SideChannel_Blackbox_HardTokens_Pythia160M_MultiTarget_poison100_latest"
...
# ============================================================
# 4. Train baseline/proxy Pythia-160M
# ============================================================
...
# ============================================================
# 5. Reload baseline for epsilon crafting
# ============================================================
...
# ============================================================
# 10. Evaluation helpers + callback
# ============================================================
...
# ============================================================
# 11. Train final hard-token Pythia-160M
# ============================================================
...
print("\n========== Training HARD branch: Pythia-160M ==========")
hard_trainer.train()
