...
# ============================================================
# Multi-target Gradient Matching Pipeline for GPT-Neo 125M
# ============================================================
...
BASELINE_DIR = "./gptneo125_base2_multi_target"
EPS_BANK_DIR = "eps_bank_multi_target_gptneo125"
META_PATH = os.path.join(EPS_BANK_DIR, "metadata.jsonl")

HARD_MODEL_OUT = "./gptneo125_hard_poisoned_multi_target"
FINAL_SAVE_DIR = "./SideChannel_Blackbox_HardTokens_GPTNeo125_MultiTarget_poison100_latest"
...
# GPT-Neo 125M has transformer.ln_f.weight
...
# ============================================================
# Helper functions for model-family compatibility
# ============================================================
...
# ============================================================
# 4. Train baseline/proxy GPT-Neo 125M
# ============================================================
...
print("\n========== Training GPT-Neo proxy on all target neighborhoods ==========")
...
assert MATCH_PARAM_NAME in named_params, (
    f"{MATCH_PARAM_NAME} not found. Available ln_f-like params:\n"
    + "\n".join([n for n in named_params if "ln_f" in n or "ln" in n])
)
...
# ============================================================
# 7. Craft epsilon for every target-neighbor pair
# ============================================================
...
# ============================================================
# 11. Train final hard-token GPT-Neo 125M
# ============================================================
...
print("\n========== Training HARD branch: GPT-Neo 125M ==========")
hard_trainer.train()
